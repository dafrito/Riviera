...
public class GeometryTest {
    ...
    /**
     * @see Geometry#scale(java.awt.Dimension,double)
     */
    @Test
    public void testScale() {
        Dimension dim = new Dimension(100, 100);
        Geometry.scale(dim, 1);
        assertThat("Identity", dim, is(new Dimension(100, 100)));

        dim = new Dimension(100, 100);
        Geometry.scale(dim, 2);
        assertThat("Double", dim, is(new Dimension(100 * 2, 100 * 2)));

        dim = new Dimension(100, 100);
        Geometry.scale(dim, 0);
        ...
        dim = new Dimension(100, 100);
        Geometry.half(dim);
        assertThat("half", dim, is(new Dimension(50, 50)));
    ...
    public void testInterpolate() {
        ...
        Point mid = Geometry.interpolate(source, dest, .5);
    ...
    public void testBounds() {
        ...
        assertThat("Opposing signs, reversed", Geometry.bounds(new Point(-1, 1), new Point(1, -1)),
                   is(new Dimension(2, -2)));
    }
