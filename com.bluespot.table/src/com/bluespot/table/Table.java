...
public interface Table<T> extends Iterable<T> {
     ...
     * 
     * @param newOrigin the new origin of the subtable
     * @param size the new size of the subtable
     * @throws IndexOutOfBoundsException if the newOrigin is out of bounds, or
     *         if the dimensions are too large for the subTable
     ...
     * @param newOrigin the new origin of the subtable
     * @return a table that represents a partial view of this table
     * @throws IndexOutOfBoundsException if the newOrigin is out of bounds
     ...
     * 
     * @param location location of the element to return. This point is not
     *        affected by this method.
     * @return the element at the specified location.
     * @throws IndexOutOfBoundsException if the point is out of range.
     */
     ...
     * 
     * @param location location of the element to change
     * @param element element to be stored at the specified location
     * @throws IndexOutOfBoundsException if the location is out of range
