...
public interface TableIteration {
     ...
     * 
     * @param currentLocation the reference location. This point will be
     *        modified to refer to the next location.
     */
     ...
     * 
     * @param currentLocation the reference location. This point will be
     *        modified to refer to the previous location.
     */
     ...
     * 
     * @param table the table that is used to wrap {@code unwrappedPoint}
     * @param unwrappedPoint the point to wrap. This point is unaffected by this
     *        method.
     * @param targetPoint the point that is replaced by the wrapped point's
     *        values. The original values of this point are destroyed.
     */
     ...
     * <p>
     * Magnitude is defined as which location is closer in iterations to the origin
     * of this iterator strategy.
     * <p>
     ...
     * 
     * @param table the table that is used to compare these points
     * @param a the point to compare. It does not need to be wrapped. It is
     *        unaffected by this method.
     * @param b the point to compare. It does not need to be wrapped. It is
     *        unaffected by this method.
     * @return <ul>
     ...
     *         means they refer to the same location in the table. They may not necessarily
     *         be equivalent points though, due to wrapping.<li>
