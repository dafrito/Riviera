...
public interface TableIterator<T> extends Iterator<T> {
     ...
     * @throws NoSuchElementException if there are no elements before the
     *         current location
     */
    public T previous();
     ...
     * @throws NoSuchElementException if iteration was implicitly started, but
     *         the table was empty
     */
     ...
     * iteration hasn't been explicitly started.
     * 
     * @param targetPoint the point that the current location is copied to. This
     *        point's original values will be lost.
     * @throws NoSuchElementException if iteration was implicitly started, but
     *         the table was empty
     */
