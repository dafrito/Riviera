...
public final class Ranges {
    ...
    private static abstract class Range<T extends Comparable<T>> implements Iterable<T> {
        ...
        public Range(T initialValue, T endValue, T step) {
        ...
        public Iterator<T> iterator() {
            return new Iterator<T>() {
                ...
                public boolean hasNext() {
                    int comparison = this.currentValue.compareTo(Range.this.endValue);
    ...
    public static Iterable<Integer> range(int initialValue, int endValue) {
    ...
    public static Iterable<Integer> range(final int initialValue, final int endValue, final int step) {
        ...
        return new Range<Integer>(initialValue, endValue, step) {
            ...
            @Override
            public Integer add(Integer value, Integer increment) {
