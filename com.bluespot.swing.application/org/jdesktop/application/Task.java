 ...
 * subclass as the {@code startClass} and Task.class the {@code stopClass}. This
 * ResourceMap is also used to look up format strings used in calls to
...
public abstract class Task<T, V> extends SwingWorker<T, V> {
    ...
    private void initTask(final ResourceMap resourceMap, final String prefix) {
        ...
        if (resourceMap != null) {
            ...
            this.description = resourceMap.getString(this.resourceName("description"));
     ...
     * 
     * @param resourceMap
     *            the ResourceMap for the Task's user properties, can be null
     * @param resourcePrefix
     *            prefix for resource names, can be null
     * @see #getResourceMap
     * @see #setTitle
     * @see #setDescription
     * @see #setMessage
     ...
     */
    @Deprecated
    public Task(final Application application, final ResourceMap resourceMap, final String resourcePrefix) {
     ...
     * </code>. The {@code resourcePrefix} is used
     * to construct the resource names for the intial values of the {@code
     * title}, {@code description}, and {@code message} Task properties and for
     * message {@link java.util.Formatter format} strings.
     * 
     * @param resourcePrefix
     *            prefix for resource names, can be null
     * @see #getResourceMap
     ...
     */
    @Deprecated
    public Task(final Application application, final String resourcePrefix) {
        this.application = application;
     ...
     * 
     * @param suffix
     *            the resource name's suffix
     * @see #getResourceMap
     * @see #message
     */
    protected final String resourceName(final String suffix) {
     ...
     * useful for describing it to the user. The {@code title} should be
     * specific to this Task, for example "Loading image
     ...
     * 
     * @param title
     *            a brief one-line description of the this Task.
     * @see #getTitle
     * @see #setDescription
     * @see #setMessage
     */
     ...
     * is the value of the {@link #getResourceMap resourceMap's} {@code
     ...
     * 
     * @param description
     *            a few sentences that describe what this Task is for.
     * @see #getDescription
     * @see #setTitle
     * @see #setMessage
     */
     ...
     * 
     * @param formatResourceKey
     *            the suffix of the format string's resource name.
     * @param args
     *            the arguments referred to by the placeholders in the format
     *            string
     * @see #setMessage
     * @see ResourceMap#getString(String, Object...)
     * @see java.text.MessageFormat
     */
    protected final void message(final String formatResourceKey, final Object... args) {
     ...
     * @see #setMessage
     */
    public long getMessageDuration(final TimeUnit unit) {
        long messageTime;
        synchronized (this) {
            messageTime = this.messageTime;
        }
        final long dt = (messageTime == -1L) ? 0L : Math.max(0L, System.currentTimeMillis() - messageTime);
     ...
     * method. If you override {@code process} and do not call {@code
     ...
     */
    @Override
    protected void process(final List<V> values) {
    ...
    protected void failed(final Throwable cause) {
        final String msg = String.format("%s failed: %s", this, cause);
        Task.logger.log(Level.SEVERE, msg, cause);
    }
    ...
    private void fireProcessListeners(final List<V> values) {
        final TaskEvent<List<V>> event = new TaskEvent(this, values);
        for (final TaskListener<T, V> listener : this.taskListeners) {
    ...
    private void fireDoInBackgroundListeners() {
        final TaskEvent<Void> event = new TaskEvent(this, null);
        for (final TaskListener<T, V> listener : this.taskListeners) {
    ...
    private void fireSucceededListeners(final T result) {
        final TaskEvent<T> event = new TaskEvent(this, result);
        for (final TaskListener<T, V> listener : this.taskListeners) {
     ...
     * below).
     */
    private void fireInterruptedListeners(final InterruptedException e) {
        final TaskEvent<InterruptedException> event = new TaskEvent(this, e);
        for (final TaskListener<T, V> listener : this.taskListeners) {
     ...
     * below).
     */
    private void fireFailedListeners(final Throwable e) {
        final TaskEvent<Throwable> event = new TaskEvent(this, e);
        for (final TaskListener<T, V> listener : this.taskListeners) {
    ...
    private class StatePCL implements PropertyChangeListener {
        public void propertyChange(final PropertyChangeEvent e) {
            ...
            if ("state".equals(propertyName)) {
                final StateValue state = (StateValue) (e.getNewValue());
     ...
     * sake of input blocking, a Task begins executing when it's
     ...
     * be blocked:
     * <dl>
     * <dt><b><code>Task.BlockingScope.NONE</code></b>
     * <dt>Don't block input. The blocking target is ignored in this case.
     * <p>
     * </p>
     * <dt><b><code>Task.BlockingScope.ACTION</code></b>
     * <dt>Disable the target {@link javax.swing.Action Action} while the Task
     * is executing.
     * <p>
     * </p>
     * <dt><b><code>Task.BlockingScope.COMPONENT</code></b>
     * <dt>Disable the target {@link java.awt.Component} Component while the
     * Task is executing.
     * <p>
     * </p>
     * <dt><b><code>Task.BlockingScope.WINDOW</code></b>
     * <dt>Block the Window ancestor of the target Component while the Task is
     * executing.
     * <p>
     * </p>
     * <dt><b><code>Task.BlockingScope.Application</code></b>
     * <dt>Block the entire Application while the Task is executing. The
    ...
    public static abstract class InputBlocker extends AbstractBean {
         ...
         * 
         * @param task
         *            block input while this Task is executing
         * @param scope
         *            how much of the GUI will be blocked
         * @param target
         *            the GUI element that will be blocked
         * @param action
         *            the {@code @Action} that triggered running the task, or
         *            null
         * @see TaskService#execute
         */
        public InputBlocker(final Task task, final BlockingScope scope, final Object target,
