 ...
 * <a
 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4780441">4780441</a>
...
public abstract class AbstractBean {
    ...
    private static class EDTPropertyChangeSupport extends PropertyChangeSupport {
         ...
         * 
         */
        private static final long serialVersionUID = -4793027316464037610L;

        EDTPropertyChangeSupport(final Object source) {
            super(source);
        }
        ...
        public void firePropertyChange(final PropertyChangeEvent e) {
            if (SwingUtilities.isEventDispatchThread()) {
                ...
                final Runnable doFirePropertyChange = new Runnable() {
                    public void run() {
