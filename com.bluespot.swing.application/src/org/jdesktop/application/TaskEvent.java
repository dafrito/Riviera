...
public class TaskEvent<T> extends EventObject {
     ...
     * 
     */
    private static final long serialVersionUID = 1002295178013189512L;
     ...
     * 
     * @param source
     *            the {@code Task} that produced the value.
     * @param value
     *            the value, null if type {@code T} is {@code Void}.
     */
    public TaskEvent(final Task source, final T value) {
        super(source);
        this.value = value;
    }
}
