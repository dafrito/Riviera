...
public interface TaskListener<T, V> {
     ...
     * 
     * @param event
     *            a TaskEvent whose source is the {@code Task} object, value is
     *            null
     ...
     * 
     * @param event
     *            a TaskEvent whose source is the {@code Task} object and whose
     *            value is a list of the values passed to the {@code
     *            Task.process()} method
     * @see Task#doInBackground
     * @see Task#process
     * @see TaskEvent#getSource
     ...
     * @param event
     *            a TaskEvent whose source is the {@code Task} object, and whose
     *            value is the value returned by {@code Task.get()}.
     * @see Task#succeeded
     * @see TaskEvent#getSource
     * @see TaskEvent#getValue
     */
     ...
     * called. The event's value is the Throwable passed to {@code
     * Task.failed()}.
     * 
     * @param event
     *            a TaskEvent whose source is the {@code Task} object, and whose
     *            value is the Throwable passed to {@code Task.failed()}.
     * @see Task#failed
     * @see TaskEvent#getSource
     * @see TaskEvent#getValue
     */
     ...
     * @param event
     *            a TaskEvent whose source is the {@code Task} object, and whose
     *            value is the InterruptedException passed to {@code
     *            Task.interrupted()}.
